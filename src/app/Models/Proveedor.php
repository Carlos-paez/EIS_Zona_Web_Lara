...
class Proveedor extends Model
{
    ...
    {
        // Consulta parametrizada que selecciona todas las columnas del proveedor
    ...
    {
        // Inserta un nuevo proveedor con los datos proporcionados
    ...
    {
        // Actualiza todos los campos del proveedor identificado por ID
